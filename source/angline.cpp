...
namespace assignment1{
    AngLine::AngLine(std::shared_ptr<AngNode> node1, std::shared_ptr<AngNode> node2) :
        mNode1(node1),
        mNode2(node2),
    ...
    void AngLine::renderGeometry(atlas::math::Matrix4 projection, atlas::math::Matrix4 view)
    {
