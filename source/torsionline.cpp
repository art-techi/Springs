/* Holds constructor for angular line shared pointer object.
 * Extended version of the line source file "line.cpp"
 * Creates a line given two nodes and renders the geometry
...
namespace assignment1{
    TorsionLine::TorsionLine(std::shared_ptr<TorsionNode> node1, std::shared_ptr<TorsionNode> node2) :
        mNode1(node1),
        mNode2(node2),
    ...
    void TorsionLine::renderGeometry(atlas::math::Matrix4 projection, atlas::math::Matrix4 view)
    {
